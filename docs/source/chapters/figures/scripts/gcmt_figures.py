...
outnamepng = os.path.join(lpy.DOCFIGURES, "gcmt_depth_moment.png")
...
_, ax, _, _ = lpy.plot_quakes(latitude, longitude, depth, moment,
                              cmap='rainbow_r', yoffsetlegend=0.05)
outnamepdf = os.path.join(lpy.DOCFIGURES, "gcmt_depth_moment.pdf")
...
outnamepng = os.path.join(lpy.DOCFIGURES, "gcmt_depth_moment_tonga.png")
plt.savefig(outnamepng, dpi=300)

outnamepdf = os.path.join(lpy.DOCFIGURES, "gcmt_depth_moment_tonga.pdf")
plt.savefig(outnamepdf)
plt.close()
...
# Save as PNG
outnamepng = os.path.join(lpy.DOCFIGURES, "gcmt_depth_moment_compare.png")
plt.savefig(outnamepng, dpi=300)

# Save as PDF
outnamepdf = os.path.join(lpy.DOCFIGURES, "gcmt_depth_moment_compare.pdf")
plt.savefig(outnamepdf)
...
# Save as PNG
outnamepng = os.path.join(lpy.DOCFIGURES, "gcmt_depth_moment_compare_side.png")
plt.savefig(outnamepng, dpi=300)

# Save as PDF
outnamepdf = os.path.join(lpy.DOCFIGURES, "gcmt_depth_moment_compare_side.pdf")
plt.savefig(outnamepdf)
